...
let jsonData = JSON.parse(fs.readFileSync('fixtures/seo-frontend.navigation.page.json', 'utf8'));
...
// Load URLs from JSON file
jsonData = JSON.parse(fs.readFileSync('fixtures/seo-frontend.detail.page.json', 'utf8'));
